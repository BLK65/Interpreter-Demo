...
FILE* readcode;     // File for writing our code in and reading it
FILE* symboltable;  // Symbol table to keep track of variables


// Defining the data types, keywords, and tokens
typedef enum {
...
// Global return variable to be used by gettoken and ungettoken functions
